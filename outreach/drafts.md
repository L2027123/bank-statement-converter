# Cold Email Drafts — Bank Statement Converter

> **Manual sending only.** Copy each draft, paste into Outlook (junliang2027@outlook.com), click Send yourself.
> Max 5 per day. Send 9-11 AM US Eastern for best open rates.

---

## Draft 1 — Big Accountants

**To**: mail@bigaccountants.com
**Subject**: 30-second demo: AI bank statement → Excel (works on Chase/WF/BofA)
...
No login needed for demo mode. If it fits your workflow, I'd love 10 minutes to show you the real thing on a sample statement.
...
**Subject**: A small tool your accounting-firm clients could use for free
...
Worth a 10-minute call? I'm not trying to replace Botkeeper — just fill the gap before Botkeeper takes over.
...
## Draft 3 — Veridis Company

**To**: info@veridiscompany.com
**Subject**: Cut statement-processing time for your small biz clients
...
If you'd like to try it on a real client statement, reply with "yes" and I'll send a Pro account invite (50 statements/month, free for 30 days, no obligation).
...
## Draft 4 — AccountingDepartment.com

**To**: Info@AccountingDepartment.com
**Subject**: A time-saver for your bookkeeping team (AI statement parser)
...
Try the demo (no login): https://bank-statement-converter-lemon.vercel.app/?demo=true

10-minute call to walk through it on a real statement? I'm free this week.
...
**Subject**: Speed up your offshore team's bank-statement processing
...
If your offshore team could save 1-2 hours/day, worth a 10-minute call?
...
## Draft 6 — Numerawise Solutions

**To**: care@numerawisesolutions.com
**Subject**: Faster bank statement → Excel for your bookkeeping clients
...
Free tier: 3 statements/month. Pro: 50/month for $19.
...
**Subject**: A small tool for inDinero's statement-processing volume
...
10-minute call to walk through it on a real client statement? I'm free this week.
...
## Notes for You (the sender)

- Replace `[Your Name]` with how you want to sign off (e.g., "Junliang" or your English name)
- These are starting points — feel free to tweak wording before sending
- If a prospect's website shows a specific person's email (e.g., founder@company.com), prefer that over the generic info@
- Send 1-2 first, see reply rate, then continue with the rest
- If you get a "not interested" reply, ask "what's the biggest pain point in your statement workflow?" — that's valuable market research
